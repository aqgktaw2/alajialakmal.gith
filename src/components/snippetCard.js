...
const shapes = [
	...
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
		<path
			fill="#F06"
			d="M131.6 66.7c12.3 5.9 27.1 13.1 30.8 23.8 3.7 10.7-3.8 24.9-13.2 34.9-9.3 10.1-20.7 16-33.7 23.4-13 7.4-27.7 16.3-40.1 13.9-12.4-2.4-22.5-16.1-30-30.5-7.6-14.5-12.7-29.7-6.4-39 6.4-9.3 24.1-12.7 36.1-18.6 12.1-5.9 18.5-14.2 26.5-16.2 8.1-2 17.8 2.5 30 8.3z"
		/>
	</svg>,
];
