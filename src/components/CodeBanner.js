const CodeBanner = () => {
	return (
		<section className="code-banner-section">
			<div className="code-banner-section__inner">
				<div className="code-banner-section__left">
					<h1>Denny Hong</h1>
					<h2>Web Developer</h2>
				</div>
				<div className="code-banner-section__right">
					<div className="code-banner-section__right-inner">
						<SvgInterface />
					</div>
				</div>
			</div>
...
const SvgInterface = (props) => (
	<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 730 900" {...props}>
		<g id="background-illustration">
			...
			<path
				id="BtnRight"
				fill="#a30292"
				d="M420.3 510.837l135.9 78.4v37.6l-136-78.4.1-37.6z"
			></path>
			<path
				id="Vector_12"
				fill="#fff"
