...
const CodeBanner = () => {
  ...
  useEffect(() => {
    ...
    const tl = new gsap.timeline({ defaults: { ease: "elastic.out(1.2, 0.4)", duration: 2.5 } });
    tl.set(h1.current.querySelectorAll("span"), {
      display: "inline-block",
      opacity: 0,
      y: 25,
    })
      .set(h2.current.querySelectorAll("span"), { display: "inline-block", opacity: 0, y: 25 })
  ...
  return (
    <section className="section-code-banner">
      <div className="section-code-banner__stars" />
      <div className="section-code-banner__stars--2" />
      <div className="section-code-banner__stars--3" />
