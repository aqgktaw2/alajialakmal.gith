...
function SvgIconNode(props) {
	return (
		...
		>
			<defs>
				<linearGradient x1="68.188%" y1="17.487%" x2="27.823%" y2="89.755%" id="icon-node_svg__b">
				...
				<linearGradient x1="43.277%" y1="55.169%" x2="159.245%" y2="-18.306%" id="icon-node_svg__d">
				...
				<linearGradient x1="-4413.77%" y1="13.43%" x2="5327.93%" y2="13.43%" id="icon-node_svg__e">
				...
				<linearGradient x1="-4.389%" y1="49.997%" x2="101.499%" y2="49.997%" id="icon-node_svg__f">
					<stop stopColor="#6CC04A" offset="9.192%" />
					<stop stopColor="#66B848" offset="28.64%" />
					<stop stopColor="#54A044" offset="59.68%" />
					<stop stopColor="#41873F" offset="86.24%" />
				</linearGradient>
				<linearGradient x1="-9713.77%" y1="36.21%" x2="27.93%" y2="36.21%" id="icon-node_svg__g">
					<stop stopColor="#6CC04A" offset="9.192%" />
					<stop stopColor="#66B848" offset="28.64%" />
					<stop stopColor="#54A044" offset="59.68%" />
					<stop stopColor="#41873F" offset="86.24%" />
			...
			<g fill="none">
				...
				<g transform="translate(134.068 70.501)">
					<mask id="icon-node_svg__c" fill="#fff">
						<use xlinkHref="#icon-node_svg__a" />
					</mask>
					<use fill="url(#icon-node_svg__b)" xlinkHref="#icon-node_svg__a" />
					<g mask="url(#icon-node_svg__c)">
					...
					<g mask="url(#icon-node_svg__c)">
						...
						<path
							...
							fill="url(#icon-node_svg__f)"
							fillRule="evenodd"
							transform="translate(0 -9.246)"
						/>
						<path
							fill="url(#icon-node_svg__g)"
							fillRule="evenodd"
						...
						<path
							...
							fill="url(#icon-node_svg__h)"
							fillRule="evenodd"
							transform="translate(0 -9.246)"
						/>
						<path
							d="M106.792 105.636l-48.773 28.085a6.973 6.973 0 01-2.196.693l.925 1.734 54.089-31.32v-.694l-1.387-2.312c-.231 1.618-1.271 3.005-2.658 3.814z"
							fill="url(#icon-node_svg__i)"
							fillRule="evenodd"
							transform="translate(0 -9.246)"
						/>
					</g>
